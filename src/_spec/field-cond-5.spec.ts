...
describe("field-cond-5", function() {
    it("Id field condition (16-1): non param types (array - string)", function() {
    ...
    it("Id field condition (16-2): non param types (array - number)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
                (testspec_pass_thru(id)>'' or testspec_pass_thru(foo)>'')
                and (id in (-100) or bar>'')
                and (baz>'' or qux>'')
            `, []);
    ...
    it("Id field condition (16-3): non param types (array - boolean)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
                (testspec_pass_thru(id)>'' or testspec_pass_thru(foo)>'')
                and (id in (false) or bar>'')
                and (baz>'' or qux>'')
            `, []);
    ...
    it("Id field condition (16-4): non param types (array - date)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
                (testspec_pass_thru(id)>'' or testspec_pass_thru(foo)>'')
                and (id in (2020-12-31) or bar>'')
                and (baz>'' or qux>'')
            `, []);
    ...
    it("Id field condition (16-5): non param types (array - datetime)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
                (testspec_pass_thru(id)>'' or testspec_pass_thru(foo)>'')
                and (id in (2020-12-31T01:02:03Z) or bar>'')
                and (baz>'' or qux>'')
            `, []);
    ...
    it("Id field condition (16-6): non param types (array - null)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
                (testspec_pass_thru(id)>'' or testspec_pass_thru(foo)>'')
                and (id in (null) or bar>'')
                and (baz>'' or qux>'')
            `, []);
    ...
    it("Id field condition (16-7): non param types (array - 'null')", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
