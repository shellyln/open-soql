...
describe("field-cond-2", function() {
    it("Id field condition (13-1): types (string)", function() {
    ...
    it("Id field condition (13-2): types (number)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (13-3): types (boolean)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (13-4): types (date)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (13-5): types (datetime)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (13-6): types (null)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (13-7): types (null)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (13-8): types ('null')", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
