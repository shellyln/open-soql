...
describe("field-cond-4", function() {
    it("Id field condition (15-1): non param types (string)", function() {
    ...
    it("Id field condition (15-2): non param types (number)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (15-3): non param types (boolean)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (15-4): non param types (date)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
                (testspec_pass_thru(id)>'' or testspec_pass_thru(foo)>'')
                and (id>2020-12-31 or bar>'')
                and (baz>'' or qux>'')
            `, []);
    ...
    it("Id field condition (15-5): non param types (datetime)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
                (testspec_pass_thru(id)>'' or testspec_pass_thru(foo)>'')
                and (id>2020-12-31T01:02:03Z or bar>'')
                and (baz>'' or qux>'')
            `, []);
    ...
    it("Id field condition (15-6): non param types (null)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (15-7): non param types (null)", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
    ...
    it("Id field condition (15-8): non param types ('null')", function() {
        const query = prepareQuery(builder, `
            Select id
            from contact
            where
